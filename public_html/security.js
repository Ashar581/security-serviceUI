document.addEventListener('DOMContentLoaded', () => {
    ...
    handleAddButton(addWatcherBtn, tagsContainerWatchers, 'https://securellance.onrender.com/api/user/add-live-listeners', 'Watchers added successfully!', 'Failed to add watchers.', emailInputWatchers, 'allowedUsers');
    handleAddButton(addSosBtn, tagsContainerSOS, 'https://securellance.onrender.com/api/user/add-sos', 'SOS contacts added successfully!', 'Failed to add SOS contacts.', emailInputSOS, 'sosContacts');
    ...
    function fetchEmailSuggestions(query, suggestionsList) {
        ...
        fetch(`https://securellance.onrender.com/api/user/email-search?query=${query}`,{
